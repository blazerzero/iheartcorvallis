  ...
  <head>
    ...
    function drawRegressionChart() {
      ...
      $(document).ready(function() {
        ...
        var t_pValue = jStat.ttest(<?php echo $t0; ?>, <?php echo count($arrY); ?>);
        document.getElementById("t-pvalue").innerText = "Two-sided p-value: " + t_pValue;

        var f_pValue = jStat.ftest(<?php echo $f0; ?>, 1, <?php echo count($arrY); ?>);
        document.getElementById("f-pvalue").innerText = "p-value: " + f_pValue;
      });
      </script>
    </head>
    <body>
        ...
        <table>
          <tr>
            <td>
              ...
              <h3 style="color:red">Least Squares Regression Line:<br>y = <?php echo number_format($b0, 4); ?> + <?php echo number_format($b1, 4); ?>x</h3>
              ...
              <h4>Sample Size: <?php echo count($arrX); ?></h4>
              ...
              <h4>Beta<sub>0</sub>: <?php echo number_format($b0, 4); ?></h4>
              <h4>Beta<sub>1</sub>: <?php echo number_format($b1, 4); ?></h4>
            </td>
            <td>
              <h2>t-Test</h2>
              <h4>t-Score (<i>T<sub>0</sub></i>): <?php echo number_format($t0, 4); ?></h4>
              <h4>Degrees of Freedom: <?php echo count($arrX) - 2; ?></h4>
              <h3 style="color:red;" id="t-pvalue"></h3>
              <br><br>
              <h2>ANOVA Test</h2>
              <h4>F-Statistic (<i>f<sub>0</sub></i>): <?php echo $f0; ?></h4>
              <h4>Numerator Degrees of Freedom: 1</h4>
              <h4>Denominator Degrees of Freedom: <?php echo count($arrX) - 2; ?></h4>
              <h3 style="color:red;" id="f-pvalue"></h3>
            </td>
          </tr>
        </table>
      </center></div><br>
