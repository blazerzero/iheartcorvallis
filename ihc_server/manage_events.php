         ...
         <tbody>
            <?php foreach($ihc_events as $event): ?>
               <tr>
                  ...
                  <td>
                     <a href="edit.php?id=<?php echo $event['eventid'] ?>" class="ui blue button">Edit</a>
                     <a onclick="return confirm('Are you sure you want to delete this entry?')" href="delete.php?id=<?php echo $event['eventid'] ?>" class='ui red button'>Delete</a>
                  </td>
               </tr>
            <?php endforeach; ?>
         </tbody>
