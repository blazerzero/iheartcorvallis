<?php
   ...
   $name = $location = $dateandtime = $description = $image = $link1 = $link2 = $link3 = $row = "";
   ...
   */
   ...
   if ($alreadyExists == False) {
      $result = $mysqli->query("INSERT INTO ihc_events (name, location, dateandtime, description, image, link1, link2, link3) VALUES ('$name', '$location' , '$dateandtime', '$description', '$image', '$link1', '$link2', '$link3')");
